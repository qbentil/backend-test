...
export const UpdateDoctorInformation = async (req: Request, res: Response, next: NextFunction) => {
    try {
...
export const AddNoteToPatient = async (req: Request, res: Response, next: NextFunction) => {
    try {
...
export const GetPatientNotes = async (req: Request, res: Response, next: NextFunction) => {
    try {
        const { patientId } = req.params;
        const notes = await Services.ReadPatientNotes(new Types.ObjectId(patientId));
...
export const GetPatientMedicalHistory = async (req: Request, res: Response, next: NextFunction) => {
    try {
        const { patientId } = req.params;
        const history = await Services.ReadPatientMedicalHistory(new Types.ObjectId(patientId));
...
export const AddPatientMedicalHistory = async (req: Request, res: Response, next: NextFunction) => {
    try {
...
export const Doctorpatients = async (req: Request, res: Response, next: NextFunction) => {
...
export const GetPatientById = async (req: Request, res: Response, next: NextFunction) => {
    try {
        const { id } = req.params;
        const { tokenPayload } = req;
        const patient = await Services.MyPatient(tokenPayload?.id!, new Types.ObjectId(id));
        new ResponseHandler(res).successWithData(patient);
    }
    catch (error: any) {
        next(error);
